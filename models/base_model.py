...
class BaseModel:
    ...
    def to_dict(self):
        ...
        setattr(obj_dict, '__class__', self.__class__.__name__)
        setattr(obj_dict, 'created_at', self.created_at.isoformat())
        setattr(obj_dict, 'updated_at', self.updated_at.isoformat())
